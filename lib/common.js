...
function getLabels(config) {
  const { mergeLabel, updateLabel, updateAndMergeLabel } = config;

  if (mergeLabel === updateAndMergeLabel) {
    return {
      mergeLabel,
      updateLabel,
      updateAndMergeLabel: undefined
    };
  }

  return { mergeLabel, updateLabel, updateAndMergeLabel };
}
