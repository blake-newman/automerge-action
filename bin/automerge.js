...
async function main() {
  ...
  const updateLabel = process.env.UPDATE_LABEL;
  const updateAndMergeLabel = process.env.UPDATE_AND_MERGE_LABEL || "automerge";
